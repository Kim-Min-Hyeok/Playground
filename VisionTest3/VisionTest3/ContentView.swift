...
struct ContentView: View {
    ...
    var body: some View {
        VStack {
            ...
            if isProcessing {
                ProgressView("Processing and detecting chord areas...")
                    .padding()
            }
            ...
            HStack(spacing: 16) {
                ...
                Button(action: {
                    ...
                    isProcessing = true
                    recognizedAreas = []
                    MusicChordDetector.detectChords(in: uiImage) { areas, processed in
        ...
        // ImagePicker 파일의 ImagePicker를 사용.
